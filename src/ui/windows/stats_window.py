...
class StatsWindow(QWidget):
    ...
    def update_data(self, datasets, fallback_summary, config):
        ...
        for entry in datasets:
            ...
            self._apply_dataset_to_tab(tab_info, entry.get("data", {}), summary_obj, steam_id_value)
    ...
    def _build_stats_tab(self, include_summary):
        ...
        return {
            ...
            "stats": {"game_count": lbl_game_count, "total_time": lbl_total_time},
    ...
    def _apply_dataset_to_tab(self, tab_info, data, summary, steam_id):
        ...
        stats_refs["total_time"].setText(f"{int(total_min / 60)} 小时")
